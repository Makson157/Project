...
colors = ((0, 0, 225), (0, 225, 0), (225, 0, 0), (225, 225, 0), (255, 20, 147), (0, 255, 255), (255, 255, 255), (154, 205, 50))  # синий, зеленый, красный, желтый
lightcolors = ((30, 30, 255), (50, 255, 50), (255, 30, 30),
               (255, 255, 30), (255, 20, 147), (0, 255, 255), (255, 255, 255), (154, 205, 50))  # светло-синий, светло-зеленый, светло-красный, светло-желтый
...
def main():
    ...
    pg.display.set_caption('Прогаммка Тетрис')
    showText('Тетрис')
...
def showText(text):
    ...
    pressKeySurf, pressKeyRect = txtObjects('Нажмите любую клавишу клавиатуры для продолжения', basic_font, title_color)
...
def drawTitle():
    ...
    titleRect.topleft = (window_w - 385, 30)
    display_surf.blit(titleSurf, titleRect)
